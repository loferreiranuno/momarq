...
/// <inheritdoc />
public partial class AddPauseResumeAndProductImport : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        // Add pause fields to crawl_jobs
        ...
        // Add import fields to crawl_extracted_products
        migrationBuilder.AddColumn<int>(
            name: "status",
        ...
        migrationBuilder.AddForeignKey(
            name: "FK_crawl_extracted_products_admin_users_reviewed_by_admin_user_id",
            table: "crawl_extracted_products",
            column: "reviewed_by_admin_user_id",
            principalTable: "admin_users",
            principalColumn: "id",
